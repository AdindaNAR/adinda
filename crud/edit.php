...
<html>
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control"  name="noSurat" value="<?php echo $isi['no_surat'] ?>" placeholder="SK-2021-09001">
  </div>
  <div class="col-md-6">
  ...
  <div class="col-6">
    ...
    <input type="date" class="form-control"  name="tglSurat" value="<?= $isi['tgl_surat'] ?>">
  </div>
  <div class="col-md-6">
    <label for="inputMengetahui4" class="form-label">Mengetahui</label>
    <input type="text" class="form-control"  name="ttdMengetahui" value="<?= $isi['ttd_mengetahui'] ?>">
  </div>
  <div class="col-6">
    <label for="inputTtdSurat" class="form-label">Pembuat Surat</label>
    <input type="text" class="form-control" name="ttdSurat" value="<?= $isi['ttd_surat'] ?>">
  </div>
  <div class="col-md-6">
    <label for="inputSetuju" class="form-label">Menyetujui</label>
    <input type="text" class="form-control"  name="ttdMenyetujui" value="<?= $isi['ttd_menyetujui'] ?>">
  </div>
  <div class="col-12">
